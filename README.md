...
> [!IMPORTANT]
> If you want to use the material force cacher, and the prefab force cacher, drag all your prefabs and materials into their lists on the `BootstrapCacheMaterialsModule` and the `BootstrapCachePrefabsModule` component
